...
<section class="ip-section">
  <div class="container">
    ...
    <div class="bgrid" style="display:grid;grid-template-columns:repeat(2,1fr);gap:1.5rem;margin-top:1.5rem">
